...
PICS = (environ.get('PICS', 'https://vault.pictures/p/f4049b5823794cdd8dc12343461e9f0d,https://vault.pictures/p/4dc7babfafad4426b80af5952a14d305')).split()
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '3470027174'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '3444088646').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '3414626754') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-5082594036')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-5092135670')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '3394469778').split()]  # For Multiple Id Use One Space Between Each.
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+Jlaql1-MlaBmMGM1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+zljQ5oHe_DRlMjU1') # Support Chat Link Without https:// or @
